...
r.paint([цвет]) # Закрасить указанным цветом. По умолчанию зеленым
...
r.freeUp() # Сверху свободно?
r.freeDown() # Снизу свободно?
r.freeRight() # Справа свободно?
r.freeLeft() # Слева свободно?

r.wallUp() # Сверху стена?
r.wallDown() # Снизу стена?
r.wallRight() # Справа стена?
r.wallLeft() # Слева стена?
...
r.paint() # Закрасит текущую клетку зеленым цветом
#-------------------
r.paint('red') # Закрасит текущую клетку красным цветом
#-------------------
r.paint(r.randcolor()) # Закрасит текущую клетку случайным цветом
#-------------------
r.paint(r.label()) # Закрасит текущую клетку цветом метки в этой клетке
#-------------------
"""
        d = self._d+1
...
#-------------------
if r.wallUp(): r.paint() # Закрасить, если сверху стена
#-------------------
if r.wallUp(): r.paint() # Закрасить, если сверху стена
#-------------------
if r.wallUp(): 
    r.paint() # Закрасить, если сверху стена
    r.right() # Перейти вправо
#-------------------
while r.wallUp(): # Идти вправо, пока сверху есть стена
    r.right()
"""
...
#-------------------
if r.wallDown(): r.paint() # Закрасить, если снизу стена
#-------------------
if r.wallDown(): r.paint() # Закрасить, если снизу стена
#-------------------
if r.wallDown(): 
    r.paint() # Закрасить, если снизу стена
    r.right() # Перейти вправо
#-------------------
while r.wallDown(): # Идти вправо, пока снизу есть стена
    r.right()
"""
...
#-------------------
if r.wallLeft(): r.paint() # Закрасить, если слева стена
#-------------------
if r.wallLeft(): r.paint() # Закрасить, если слева стена
#-------------------
if r.wallLeft(): 
    r.paint() # Закрасить, если слева стена
    r.down() # Перейти вниз
#-------------------
while r.wallLeft(): # Идти вниз, пока слева есть стена
    r.down()
"""
...
#-------------------
if r.wallRight(): r.paint() # Закрасить, если справа стена
#-------------------
if r.wallRight(): r.paint() # Закрасить, если справа стена
#-------------------
if r.wallRight(): 
    r.paint() # Закрасить, если справа стена
    r.down() # Перейти вниз
#-------------------
while r.wallRight(): # Идти вниз, пока справа есть стена
    r.down()
"""
...
#-------------------
if r.freeUp(): r.paint() # Закрасить, если сверху свободно
#-------------------
if r.freeUp(): r.up() # Шагнуть вверх, если сверху свободно
#-------------------
if r.freeUp(): 
    r.up() # Шагнуть вверх
    r.paint() # Закрасить
    r.down() # Перейти вниз
#-------------------
while r.freeUp(): # Идти вверх, пока сверху свободно
    r.up()
"""
...
#-------------------
if r.freeDown(): r.paint() # Закрасить, если снизу свободно
#-------------------
if r.freeDown(): r.down() # Шагнуть вверх, если снизу свободно
#-------------------
if r.freeDown(): 
    r.down() # Шагнуть снизу
    r.paint() # Закрасить
    r.up() # Перейти вверх
#-------------------
while r.freeDown(): # Идти вниз, пока снизу свободно
    r.down()
"""
...
#-------------------
if r.freeLeft(): r.paint() # Закрасить, если слева свободно
#-------------------
if r.freeLeft(): r.left() # Шагнуть влево, если слева свободно
#-------------------
if r.freeLeft(): 
    r.left() # Шагнуть влево
    r.paint() # Закрасить
    r.right() # Перейти вправо
#-------------------
while r.freeLeft(): # Идти влево, пока слева свободно
    r.left()
"""
...
if r.color():
    ...
    r.down()
#-------------------
if r.color() == 'red': r.right() # Вправо, если закрашено красным
#-------------------
"""
...
#-------------------
r.paint(r.randcolor()) # Закрасить случайным цветом
#-------------------
...
#-------------------
if r.label() == 'red': r.paint('red') # Закрасить клетку красным, если метка красная
#-------------------
"""
...
#-------------------
if r.gettext() != '': r.right() # Перейти вправо, если в ячейке есть какой-нибудь текст
#-------------------
if r.gettext() == '3': r.right() # Перейти вправо, если в ячейке записано 3
#-------------------
n = r.gettext()
...
"""            
            ...
            self._task += 'r.paint("red") - закрасить красным \n'
...
"""            
            ...
            self._task += 'Название цвета - в кавычках, внутри скобок:  r.paint("cyan")'
...
"""   
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
if r.freeRight(): r.right()
"""             
            
            self._task = 'Если справа нет стены, то сделать шаг вправо \n'
            self._task += 'Использовать r.freeRight() или r.isPark() \n'
...
"""             
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
if r.freeUp(): r.up()
elif r.freeDown(): r.down()
elif r.freeRight(): r.right()
elif r.freeLeft(): r.left()
"""             
...
if r.freeUp(): 
    r.up()
    if r.freeUp() and r.color(): p = True
    r.down()
    if p: r.paint()
"""         
...
p = False
r.up()
if r.wallUp() and r.color() =='red': p = True
r.down()
if p: r.paint()
"""         
...
r.right()
if not r.color(): r.left()
else:
    r.lt(2)
    if not r.color(): r.right()
    else:
        r.right()
        r.up()
        if not r.color(): r.down()
        else:
            r.dn(2)
            if not r.color(): r.up()
            else: 
...
"""
            ...
            self._task += 'r.paint(r.randcolor())\n'
            self._test = '''
p = l = True
r = c = 1
cc = 0
...
while r.freeDown(): r.down()
while r.wallDown(): r.right()
r.down()
while r.freeLeft(): r.left()
"""             
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            for c in range(0,dc):
                if rnd(0,2) == 1:
                    ...
                    self._field[4+1][4+c].wUp = True
            self._solve = """
while r.wallDown() or r.wallUp(): r.right()
"""            
...
"""
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
while r.wallRight():
    while r.wallRight(): r.up()
    r.right()
    r.down()
    while r.wallLeft(): r.down()
    r.up()
"""
            self.sleep = 0.04
            self._task = 'Дойти до конца забора\n'
...
while r.freeUp():
    r.up()
    if r.wallRight(): r.paint()
while r.wallRight(): r.down()
"""                    
...
"""
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
w = 1
while r.freeRight() or w <= 2:
    if r.wallUp() or r.wallDown(): r.paint()
    if r.freeRight(): 
        r.right()
    else:
        w += 1
...
"""
        ...
        ##--------------------------------------------------------------------------------------------        
            ...
            self._solve = """
while r.freeRight():
    if r.wallUp() and r.wallDown(): r.paint()
    r.right()           
...
"""
        ...
        ##--------------------------------------------------------------------------------------------        
            ...
            self._solve = """
while r.freeRight():
    if r.freeUp() and r.freeDown(): r.paint()
    r.right()           
"""
            self.sleep = 0.04
            self._task = 'Закрасить отмеченные'
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
while r.freeRight():
    if r.freeUp() and r.wallDown(): r.paint()
    r.right()           
"""
            self.sleep = 0.04
            self._task = 'Закрасить отмеченные'
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
while r.freeRight():
    if not (r.wallDown() and r.wallUp()): r.paint()
    r.right()           
"""
            self.sleep = 0.04
            self._task = 'Закрасить отмеченные'
...
while r.freeRight():
    ...
    if r.freeDown():
        ...
        r.paint()
        r.up()
    if r.wallDown() and r.wallUp(): r.paint()
    r.right()           
"""
...
"""
        ...
        ##--------------------------------------------------------------------------------------------        
            ...
            self._solve = """
while r.freeRight():
    if r.color() and r.freeUp() or r.freeUp() and r.freeDown(): 
        r.up()
        r.paint()
        r.down()
    r.right()           
...
while r.freeRight():
    if r.freeUp(): 
        r.up()
        if r.wallLeft() and r.wallRight() and r.wallUp():
            r.down()
            r.paint()
        else:
            r.down()
...
"""
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
while r.freeRight():
    if r.color() and r.freeUp() and r.wallDown() or r.freeUp() and r.freeDown() and not r.color(): 
        r.up()
        r.paint()
        r.down()
    r.right()           
...
while r.freeRight():
    ...
    if r.freeUp():
        ...
        c_up = r.color()
        r.down()
        if r.freeDown() and c_up: 
            r.down()
            c_d = r.color()
            r.up()
    if c_d and c_up: r.paint()
    r.right()           
"""
...
while r.freeRight():
    ...
    if r.freeUp():
        ...
        while r.freeDown(): r.down()
        if green > red: r.paint()
        elif red > green: r.paint('red')
        else: r.paint('cyan')
...
while not r.color():
    r.up()
r.right()
while not r.color() and r.freeRight(): 
    r.right()
if r.wallRight():
    while not r.color(): 
        r.left()
...
"""
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve= """
r.sleep = 0.04
while r.wallUp() and r.wallDown() and r.freeLeft():
    r.left()
if r.wallUp() and r.wallDown() and r.wallLeft(): 
    while r.wallUp() and r.wallDown() and r.freeRight():
        r.right()
if r.wallUp() and r.wallDown() and r.wallRight(): 
...
"""
        ...
        ##--------------------------------------------------------------------------------------------
            ...
            self._solve = """
while r.freeRight(): r.right()
while r.freeLeft() and r.wallDown(): r.left()
while r.freeDown(): 
    r.down()
    while r.freeRight(): r.right()
    while r.freeLeft() and r.wallDown(): r.left()
...
for rr in range(19):
    for cc in range(19):
        if rr > (19-cc-1): r.paint('yellow')
        if rr < (19-cc-1): r.paint('red')
        r.right()
    r.lt(19)
    r.down()
"""
...
for rr in range(19):
    for cc in range(19):
        if rr > cc and rr > (19-cc-1): r.paint('yellow')
        if rr > cc and rr < (19-cc-1): r.paint('red')
        if rr < cc and rr > (19-cc-1): r.paint('green')
        if rr < cc and rr < (19-cc-1): r.paint('blue')
        r.right()
    r.lt(19)
    r.down()
"""
...
while not r.gettext():
    ...
    r.settext(a)
    if d == 0:
        if r.freeRight() and not gtr(): 
            r.right()
        else: 
            r.down()
            d += 1
    elif d == 1:
        if r.freeDown() and not gtd(): 
            r.down()
        else:
            d += 1
            r.left()
    elif d == 2:
        if r.freeLeft() and not gtl(): 
            r.left()
        else: 
            d += 1
            r.up()
    elif d == 3:
        if r.freeUp() and not gtu(): 
            r.up()
        else: 
            d = 0
            r.right()
